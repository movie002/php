...
{
	global $DH_home_url,$DH_src_path,$DH_output_path,$DH_output_html_path;
	...
	$DH_output_file = $DH_output_html_path.'author.html';
	dh_file_put_contents($DH_output_file,$DH_output_content);		
}

function dh_gen_static($name)
{
	global $DH_home_url,$DH_src_path,$DH_input_path,$DH_output_html_path;
	...
	$DH_output_file = $DH_output_html_path.$name.'.html';
	dh_file_put_contents($DH_output_file,$DH_output_content);
}
