...
/srv/php/timeexc.sh curl http://php.movie002.com/reader/getonlylink.php?d=10 -o /srv/php/log/getonlylink.log
## 2.1 处理onlylink，将onlylink处理到link和link2
/srv/php/timeexc.sh curl http://php.movie002.com/reader/getlink.php?d=10 -o /srv/php/log/getlink.log
...
/srv/php/timeexc.sh curl http://php.movie002.com/getpage/getpage.php?d=20 -o /srv/php/log/getpage.log
## 2.5 更新page的状态，资源数等
/srv/php/timeexc.sh curl http://php.movie002.com/getpage/updatestatus.php?d=10 -o /srv/php/log/updatestatus.log
## 2.5 得到票房信息
