...
/srv/php/timeexc.sh curl http://127.0.0.1/php/genv/static/gen.php -o /srv/php/log/genstatic.log
## 3.6 生成sitemap
/srv/php/timeexc.sh curl http://127.0.0.1/php/genv/sitemap/gen.php -o /srv/php/log/gensitemap.log
