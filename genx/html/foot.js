...
function dhsay()
{
	...
	iframe_say.innerHTML = '<iframe id="iframe_say" allowtransparency="true" width="90%" height="16px" src="http://v.movie002.com/dh_say.php" frameBorder="0" scrolling="no" ></iframe>';
}
