...
{	
	global $DH_src_path,$DH_output_path,$DH_home_url,$DH_html_url,$moviecountry,$movietype,$DH_name;
...
{
	global $DH_output_path,$DH_src_path,$DH_home_url,$DH_home_url,$DH_name;
