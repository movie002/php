...
## 3.4 生成index
/srv/php/timeexc.sh curl http://127.0.0.1/php/genx/gen_index.php -o /srv/php/log/genindex.log
## 3.2 生成pages
/srv/php/timeexc.sh curl http://127.0.0.1/php/genx/gen_page.php?d=30 -o /srv/php/log/genpage.log
## 3.3 生成list
/srv/php/timeexc.sh curl http://127.0.0.1/php/genx/gen_list.php -o /srv/php/log/genlist.log
## 3.5 生成辅助页面，友情链接之类的
/srv/php/timeexc.sh curl http://127.0.0.1/php/genx/gen_author.php -o /srv/php/log/genauthor.log
