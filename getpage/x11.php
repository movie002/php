...
$other=array('应求',"观看","首映","首款","首发","网络","独播","暑期必看","配音","最新","高分","热门","版本","版","精彩","先行","制作","官方","字幕","漢化","汉化","主要","演员","主演","主打","大片",'系列','合集',"片",'剧集','剧','年','贴','连载','更新中','更新','重现','注意','原创','左右','半宽','上下','再造','TOP','BTV','TSKS','KS','TVB','SUBPIG','OST','TSJS','BBC','票房','分辨率','每集','集','弹窗','史上','爆笑','经典','高码','重制','谁','怎么','部');
...
//$smbol=array('★','◆','×','●');
$mustnot=array('字幕','制作','&','新人','签到','工作室','跪求','求片','。','“','”');

//下面两个用在后缀，可以提权之前的
$qulity=array('高清','蓝光','清晰','720p','1080p','1080i','1280','1024','枪版','抢先','WEBRip','BluRay','x264','迅雷','BT下载','下载','快传','百度网盘','快播','百度影音','电驴','网盘','磁力连接','立体','原盘','HDTV','百度云','未分级版','最新','最强','真人版','电影版','完整版',"未删减版","全集","国语","中字","中英双字","中英字",'簡繁','简繁','繁體','繁体','简体','外挂','外掛','中文','英语','粵語','粤语','无字','無字','内嵌','马来西亚','内地','泰语');
