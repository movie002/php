...
//子集应该在父类之后
$country=array('中国','中國','大陆',"香港","台湾","澳门","国产",'港台','日剧',"日本",'日韩',"韩剧","韩国",'亚洲','欧美','美国','美國',"德国","法国",'法國',"美剧","朝鲜","澳大利亚","意大利","西班牙","越南","泰国","柬埔寨","印度",'印语',"巴基斯坦","英国","阿根廷","加拿大","俄罗斯",'俄羅斯','苏联','蘇聯',"中日","中俄",'中美','匈牙利','捷克','瑞典','南斯拉夫','西德','东德','美法','字','语','中','美','日','韩','国','英','台','港','粤','國粵','雙語');
...
$other=array('应求','跪求','哪里','哪儿',"观看","首映","首款","首发","网络","独播","暑期必看","配音","最新","高分","热门","版本","版","精彩","先行","制作","官方","字幕","漢化","汉化","主要","演员","主演","主打","大片",'系列','合集',"片",'剧集','剧','年','贴','连载','更新中','更新','重现','注意','原创','求片','左右','半宽','上下','再造','TOP','BTV','TSKS','KS','TVB','SUBPIG','OST','TSJS','BBC','票房','分辨率','每集','集','弹窗','史上','爆笑','经典','高码','重制','谁','怎么');
$del_word=array("限制级","限制","R级","三级","四级","禁片","出品",'回馈','重发','+','-','DVD','MKV','TS','DTS','BD','HD','RMVB','AVI','BT','MP4','TV','3D','WMV','mp3','mv','WEB');
$mingxing=array('郭富城','周润发','甄子丹');
//$smbol=array('★','◆','×','●');
$mustnot=array('字幕','制作','&','新人','签到','工作室');

//下面两个用在后缀，可以提权之前的
$qulity=array('高清','蓝光','清晰','720p','1080p','1080i','1280','1024','枪版','抢先','WEBRip','BluRay','x264','迅雷','下载','快传','百度网盘','快播','百度影音','电驴','网盘','磁力连接','立体','原盘','HDTV','百度云','未分级版','最新','最强','真人版','电影版',"未删减版","全集","国语","中字","中英双字","中英字",'簡繁','简繁','繁體','繁体','简体','外挂','外掛','中文','英语','粵語','粤语','无字','無字','内嵌','马来西亚','内地','泰语');
...
{
	//print_r($titlearray);
	global $country,$qulity,$type,$other,$del_word,$mustnot,$mingxing;
	$titlenext=0;
	$titlereturn='';
