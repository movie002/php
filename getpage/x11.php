...
$other=array('应求',"观看","首映","首款","首发","网络","独播","暑期必看","配音","最新","高分","热门","版本","版","精彩","先行","制作","官方","字幕","漢化","汉化","主要","演员","主演","主打","大片",'系列','合集',"片",'剧集','剧','年','贴','连载','更新中','更新','重现','注意','原创','左右','半宽','上下','再造','TOP','BTV','TSKS','KS','TVB','SUBPIG','OST','TSJS','BBC','票房','分辨率','每集','集','弹窗','史上','爆笑','经典','高码','重制','谁','怎么','部','新人','签到','报道','报到','奥斯卡','最佳','影片','提名');
