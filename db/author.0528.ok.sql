...
( 1, 0, '一路电影网', 'http://www.16movies.cn/', 'http://www.16movies.cn/feed.xml', 1, '<c>c%电影%1</c><c>c%蓝光原盘%1</c><c>l%3D%1</c><c>l%.*?%-1</c>', NULL, '<c>c%1080|蓝光%6</c><c>c%720%5</c><c>c%3D%7</c><c>l%.*?%4</c>', '<c>l%.*?%6</c>', '<c>c%电影|大片%6</c><c>c%.*?%-1</c>', '<c>x%1%1</c>', '<c>l%.*?%2</c>', NULL),
