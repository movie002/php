...
( 0, 0, '豆瓣预告', 'http://www.douban.com', 'http://www.douban.com', 0, '<c>l%.*?%0</c>', NULL, NULL, '<c>l%.*?%7</c>', '<c>l%.*?%3</c>', '<c>g%(.*?)\\(%1</c>', NULL, NULL),
...
( 1, 0, '飞鸟娱乐(论坛)', 'http://bbs.hdbird.com/', 'http://bbs.hdbird.com/rss.php', 0, NULL, NULL, NULL, '<c>l%.*?%10</c>', '<c>l%.*?%6</c>', '<c>x%1%1</c>', '<c>l%.*?%2</c>', NULL),
...
( 1, 0, '大连生活网', 'http://www.dlkoo.com/', 'http://www.dlkoo.com/down/Rss.xml', 1, '<c>c%电影%1</c><c>c%影视%1</c><c>c%电视剧%2</c><c>c%综艺%3</c><c>c%动漫%4</c>', NULL, '<c>l%.*?%3</c>', '<c>l%.*?%0</c>', '<c>l%.*?%6</c>', '<c>x%1%1</c>', '<c>l%.*?%2</c>', NULL),
...
( 1, 0, '一路电影网', 'http://www.16movies.cn/', 'http://www.16movies.cn/feed.xml', 1, '<c>c%电影%1</c><c>c%蓝光原盘%1</c><c>l%3D%1</c><c>l%.*?%-1</c>', NULL, '<c>c%1080|蓝光%6</c><c>c%720%5</c><c>c%3D%7</c><c>l%.*?%4</c>', '<c>l%.*?%6</c>', '<c>c%电影|大片|蓝光|半宽%6</c><c>c%.*?%-1</c>', '<c>x%1%1</c>', '<c>l%.*?%2</c>', NULL),
...
( 2000, 0, '网易娱乐', 'http://ent.163.com', 'http://ent.163.com', 0, '<c>c%电影%1</c><c>c%电视%2</c><c>c%综艺%3</c>', '<c>c%华语|港台%1</c><c>c%海外|欧美%2</c><c>c%日韩%3</c>', NULL, NULL, '<c>l%.*?%1</c>', '<c>g%《(.*?)》%0</c>', NULL, NULL),
