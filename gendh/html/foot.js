...
function cnzz()
{
	(function() {
		...
		cnzz.src = 'http://s22.cnzz.com/z_stat.php?id=1254734242&web_id=1254734242';
		(document.getElementsByTagName('body')[0]
...
function dhsay()
{
	...
	iframe_say.innerHTML = '<iframe id="iframe_say" allowtransparency="true" width="95%" height="16px" src="http://s.gfsoso.com/dh_say.php" frameBorder="0" scrolling="no" ></iframe>';
}
